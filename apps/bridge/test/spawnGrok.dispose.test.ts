...
import { disposeAgentProcess } from "../src/spawnGrok.js";

/** Root of a sleep tree: stdin ignored, stdout used to learn nested pid. */
type SleepTreeRoot = ChildProcessByStdio<null, Readable, Readable>;
